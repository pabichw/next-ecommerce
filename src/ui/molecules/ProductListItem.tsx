...
export const ProductListItem = ({ product }: { product: Maybe<Product> }) => {
	...
	return (
		<li className="mx-auto">
			<Link
				className="group flex flex-col gap-3 p-3 w-32 h-full bg-white rounded-md cursor-pointer outline outline-slate-100 outline-1 shadow shadow-slate-200 hover:shadow-xl"
